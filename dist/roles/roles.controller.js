...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Rolelarni ko'rish" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of Roles', type: [role_model_1.Role] }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Roleni value bo'yicha ko'rish" }),
